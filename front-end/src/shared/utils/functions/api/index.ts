...
import { isSafeParseError } from "@/shared/utils/functions/validation";
import { setupInterceptorsTo } from "@/shared/utils/functions/api/interceptor";
import { ErrorMessages } from "@/shared/utils/functions/exception/error-message";
...
interface IHttpClient {
  ...
  delete<T>(props: DeleteRequestProps): Promise<ApiSuccessResponse<T>>;
}
