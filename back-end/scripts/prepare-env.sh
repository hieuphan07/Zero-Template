...
require_variable "ACCESS_TOKEN_EXPIRATION_TIME_1"
require_variable "ACCESS_TOKEN_EXPIRATION_TIME_2"
require_variable "REFRESH_TOKEN_EXPIRATION_TIME"
...
ACCESS_TOKEN_EXPIRATION_TIME_1=$ACCESS_TOKEN_EXPIRATION_TIME_1
ACCESS_TOKEN_EXPIRATION_TIME_2=$ACCESS_TOKEN_EXPIRATION_TIME_2
